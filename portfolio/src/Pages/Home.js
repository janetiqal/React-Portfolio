...
import { Typography, makeStyles, Container, Box , Grid} from "@material-ui/core";
    ...
    <Box className={classes.intro}>
      ...
      <Box className={classes.right}>
        <Box className={classes.wrapper}>
          <Typography className={classes.text} variant="h2">Hi <span className={classes.colorChange}>friends</span>, I'm</Typography>
